...
const AddStockContent: React.FC<AddStockContentProps> = ({ defaultName, onEnter, onClose }) => {
  ...
  async function onAdd(secid: string, type: number, name?: string) {
  ...
  }, [defaultName, runSearch]);

  return (
    <CustomDrawerContent title="添加股票" enterText="确定" onEnter={onEnter} onClose={onClose}>
