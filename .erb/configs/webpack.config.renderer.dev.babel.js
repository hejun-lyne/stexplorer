...
export default merge(baseConfig, {
  ...
  entry: {
    dev: 'webpack-dev-server/client?http://localhost:1212/dist',
    server: 'webpack/hot/only-dev-server',
    mini: path.join(webpackPaths.srcRendererPath, 'mini.tsx'),
    full: path.join(webpackPaths.srcRendererPath, 'full.tsx'),
